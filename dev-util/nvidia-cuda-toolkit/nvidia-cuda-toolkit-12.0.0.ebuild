...
IUSE="debugger docs nsight profiler vis-profiler sanitizer"
...
src_prepare() {
	...
	local cuda_supported_gcc="8.5 9.4 9.5 10 10.3 10.4 11 11.1 11.2 11.3 12 12.1"
...
src_install() {
	...
	local builddirs=(
		...
		$(usex sanitizer "builds/cuda_sanitizer_api" "")
		$(usex vis-profiler "builds/cuda_nvvp" "")
		$(usex debugger "builds/cuda_gdb" "")
		$(usex docs "builds/cuda_documentation" "builds/cuda_demo_suite" "")
	)
